...
(function (global, factory) {
  ...
  var md5 = createCommonjsModule(function (module) {
    ...
    (function ($) {
      ...
      /**
       * Calculates the HMAC-MD5 of a key and some json1 (raw strings)
       *
      ...
      /**
       * Calculates the raw HMAC-MD5 for the given key and json1
       *
      ...
      /**
       * Calculates the Hex encoded HMAC-MD5 for the given key and json1
       *
       * @param {string} k HMAC key
       * @param {string} d Input string
       * @returns {string} Raw MD5 string
  ...
  var md5Attr = 'json1-md5';
  var detectionIgnoreAttr = 'json1-fa-detection-ignore';
  var timeoutAttr = 'json1-fa-detection-timeout';
  var resultsCollectionMaxWaitAttr = 'json1-fa-detection-results-collection-max-wait';
