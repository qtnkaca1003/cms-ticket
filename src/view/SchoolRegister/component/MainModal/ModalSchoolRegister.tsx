...
const ModalSchoolRegister = (props: IPropsModal) => {
  ...
  const translateFirstKey = 'schoolRegister'; //put your translate here
    ...
    <Modal
      ...
      footer={
        <ButtonForm
          ...
          nameButtonSubmit={
            typeModal == 'EDIT' ? 'common.update' : 'common.add'
          }
...
export default ModalSchoolRegister;
