...
//and get detail
export const getDetail{{pascalCase name}} = (id) => {
  return httpRepository.execute({
    path: '/api/{{name}}/' + id,
    showSuccess: false,
    showError: false,
...
//API ADD
export const create{{pascalCase name}} = (payload) => {
  return httpRepository.execute({
    path: '/api/{{name}}',
    method: 'post',
    payload,
...
//API EDIT/UPDATE
export const update{{pascalCase name}} = (id, payload) => {
  return httpRepository.execute({
    path: '/api/{{name}}/' + id,
    method: 'put',
    payload,
...
//API DELETE
export const delete{{pascalCase name}} = (id) => {
  return httpRepository.execute({
    path: '/api/{{name}}/' + id,
    method: 'delete',
  });
